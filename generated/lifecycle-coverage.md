...
| `capability.data-modeling` | `design` | `gap` | Require domain and storage experts to review invariants and lifecycle assumptions. | Declare the uncovered modeling need and avoid irreversible schema commitments. |
...
| `capability.interface-api-design` | `design` | `curated` | Evaluate alternatives against callers, failure modes, compatibility, and testability. | Expose the narrowest reversible interface and defer unsupported flexibility. |
